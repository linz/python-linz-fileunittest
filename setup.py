"""linz-fileunittest setup module
"""
...
setup(
    ...
    url='https://github.com/linz/python-linz-fileunittest',
    ...
    namespace_packages=['LINZ','LINZ.Geodetic','LINZ.Geodetic.Test'],
